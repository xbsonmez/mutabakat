...
var datePickerController = (function datePickerController() {
        var languageInfo        = parseNavigatorLanguage(),
            ...
            localeDefaults      = {
                fullMonths:["Ocak","Subat","Mart","Nisan","Mayis","Haziran","Temmuz","Agustos","Eylul","Ekim","Kasim","Aralik"],
                monthAbbrs:["Ock","Sub","Mar","Nis","May","Haz","Tem","Agu","Eyl","Ekm","Kas","Ara"],
                fullDays:  ["Pazartersi","Sali","Carsamba","Persembe","Cuma","Cumartesi","Pazar"],
                dayAbbrs:  ["Pzt","Sal","Crs","Prs","Cum","Cts","Pzr"],
                titles:    ["Onceki ay","Sonraki ay","Önceki yil","Sonraki yil", "Bugun", "Takvimi Goster", "wk", "Week [[%0%]] of [[%1%]]", "Week", "Select a date", "Click \u0026 Drag to move", "Display \u201C[[%0%]]\u201D first", "Go to Today\u2019s date", "Disabled date"],
                firstDayOfWeek:0,
                imported:  false
            }; 
