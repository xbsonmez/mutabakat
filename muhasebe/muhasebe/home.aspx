<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="home.aspx.cs" Inherits="muhasebe.home" EnableEventValidation="false" %>
<%@ Register src="menu.ascx" tagname="menu" tagprefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>ADALICAM MUHASEBE MUTABAKAT SİSTEMİ - BS / BA</title>
    <!--// Stylesheets //-->
    ...
    <script language="javascript" type="text/javascript">
        ...
        function sendMailAllSelectedCompanies() {
            ...
            for (let i = 1; i < companyRows.rows.length - 1; i++) {
        ...
        function sendAllCompaniesMails(id) {
         ...
         var a= $.ajax({
                type: "POST",
                url: "CompanyService.asmx/sendMail",
                data: "ID=" + id,
            ...
            var checkBoxRows = selectHeader.parentNode.parentNode.parentNode.parentNode;
                if (selectHeader.checked) {
                    ...
                    for (var i = 0; i < checkBoxRows.rows.length-1; i++) { 
                        ...
                        if (detailDocumentAboutRow.children[0].children[5].firstChild && detailDocumentAboutRow.children[0].children[6].firstChild) {
                            if (detailDocumentAboutRow.children[0].children[5].firstChild.textContent !== "") {
                                
                                if (detailDocumentAboutRow.children[0].children[6].firstChild.textContent == "false") {
                        ...
                        } else if (detailDocumentAboutRow.children[0].children[5] && detailDocumentAboutRow.children[0].children[6]) {
        ...
        function getDetailsSelection(i) {
              ...
              var detailDoc=$.ajax({
                    type: "POST",
                    url: "CompanyService.asmx/getDetails",
                    data: "id=" + i,
                    async: false,
        ...
        function OnSuccessCall(response) {
            $(response).find("Company").each(function () {
                ...
                var objBelgesayisi = document.getElementById('<%= lbl_belgesayisi.ClientID %>');
                var objToplamTutar = document.getElementById('<%= lbl_toplamTutar.ClientID %>');
                var objTip = document.getElementById('<%= lbl_tip.ClientID %>');
                var objID = $("#hfID");

                objUnvan.innerHTML = $(this).find("unvan").text();
                objVkno.innerHTML = $(this).find("vkno").text();
                objBelgesayisi.innerHTML = $(this).find("belgeSayisi").text();
                objToplamTutar.innerHTML = $(this).find("malHizmetBedeli").text();
                objID.val($(this).find("ID").text());

                var tip = $(this).find("mutabakatTipi").text();
                if (tip == "1") {
                    objTip.innerHTML = "BS Mutabakatı";
                }
                else {
                    objTip.innerHTML = "BA Mutabakatı";
                }
        ...
        function addCompanyMail(m) {
            ...
            $.ajax({
                type: "POST",
                url: "CompanyService.asmx/addMail",
                data: "ID=" + id + "&Mail=" + m,
        ...
        function deleteCompanyMail(m) {
           ...
           $.ajax({
                type: "POST",
                url: "CompanyService.asmx/deleteMail",
                data: "ID=" + id + "&Mail=" + m,
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="xmlFileZone">
            <asp:Panel runat="server" ID="pnl_fileUpload">
                <br />
                Lütfen bir XML veya Excel dosyası seçiniz.<br />
                <br />
              
                <asp:FileUpload ID="fileUploadXML" runat="server" CssClass="custom-file-input" Width="300px" />
                  <br />
                  <asp:Button ID="btnUpload" runat="server" OnClick="btnUpload_Click" ValidationGroup="UploadXMLFile"
                    Text="Yükle" CssClass="btn" />
                    <br />
                    <br />
                <br />
                
                <br />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" ControlToValidate="fileUploadXML"
                    ErrorMessage="<br />Seçtiğiniz dosya XML, XLXS, XLS) formatında olmalıdır." ForeColor="Red"
                    ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))(.xml|.XML|.xlsx|.XLSX|.xls|.XLS)$"
                    ValidationGroup="UploadXMLFile" SetFocusOnError="true" Display="Dynamic"></asp:RegularExpressionValidator>
                <asp:RequiredFieldValidator ID="rv" Display="Dynamic" runat="server" ControlToValidate="fileUploadXML"
                    ErrorMessage="<br />Lütfen dosya seçiniz" ValidationGroup="UploadXMLFile" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
            
                   Excel'e tıklayarak Örnek  Cari Şablonu indirebilirsiniz.
                    <br />
                      
                 <asp:Button ID="Button2" runat="server" Text="" OnClick="btnSave_Click" CssClass="excelDownload" Width="32px"/><br />       
        ...
        <div class="zone">
            <asp:Panel runat="server" ID="pnl_proccess" Visible="false">
                <asp:HiddenField ID="hfID" runat="server" Value="" />
                <div class="zone-left">
                   
       
                    <asp:ListBox ID="companyList" runat="server" CssClass="list" Height="287px"  Visible="false">
                    </asp:ListBox>
                ...
                <div class="zone-right">
                    ...
                    <div class="formItem">
                        : <strong>
                            <asp:Label Text="" runat="server" ID="lbl_donem" /></strong></div>
                    <div class="clear">
                    </div>
                    <div class="formTxt">
                        Tip
                    ...
                    <div class="formItem">
                        : <strong>
                            <asp:Label Text="" runat="server" ID="lbl_tip" /></strong></div>
                    <div class="clear">
                    </div>
                    <div class="formTxt">
                        Firma
                    ...
                    <div class="formItem">
                        : <strong>
                            <asp:Label ID="lbl_unvan" Text="" runat="server"></asp:Label></strong></div>
                    <div class="clear">
                    </div>
                    <div class="formTxt">
                        Vergi Kimlik No
                    ...
                    <div class="formItem">
                        : <strong>
                            <asp:Label ID="lbl_vkno" Text="" runat="server"></asp:Label></strong>
                    </div>
                    <div class="clear">
                    </div>
                    <div class="formTxt">
                    ...
                    <div class="formItem">
                        : <strong>
                            <asp:Label ID="lbl_belgesayisi" Text="" runat="server"></asp:Label></strong>
                    </div>
                    <div class="clear">
                    </div>
                    <div class="formTxt">
                    ...
                    <div class="formItem">
                        : <strong>
                            <asp:Label ID="lbl_toplamTutar" Text="" runat="server"></asp:Label></strong>
                    </div>
                    <div class="clear">
                    </div>
                    <div class="formTxt">
