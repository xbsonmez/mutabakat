<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CariMutabakatDetails.aspx.cs" Inherits="muhasebe.CariMutabakatDetails" %>
...
<body>
    ...
    <div class="wrapperResult">
        ...
        <div class="wrapperResult">
           <h1 style="text-align:center;"> CARİ BİLGİLERİNİ DÜZENLE VE TEKRAR GÖNDER </h1> 
        <div class="clear"></div>
        <div class="resultDetails">
            <br /><br />
             ...
             <br />
                Tarih :<asp:TextBox runat="server" ID="tarih" Text="" CssClass="txtBox"  Width="100px" ReadOnly="true"/>
             <br />
             <br />
             ...
             <br />
             <br />
                Muhasebe Kodu: <asp:TextBox runat="server" ID="muhasebeKodu" Text="" CssClass="txtBox"  Width="180px" ReadOnly="true"/>
             <br />
             <br />
                Hesap Kodu: <asp:TextBox runat="server" ID="hesapKodu" Text="" CssClass="txtBox"  Width="180px" ReadOnly="true"/>
             <br />
             <br />
                 Borç Bakiyesi: <asp:TextBox runat="server" ID="borcbakiye" Text="" CssClass="txtBox"  Width="180px" ReadOnly="true"/>
             <br />
             <br />
                 Borç: <asp:TextBox runat="server" ID="borc" Text="" CssClass="txtBox"  Width="180px" ReadOnly="true"/>
             <br />
             <br />
                 Alacak Bakiyesi : <asp:TextBox runat="server" ID="alacakbakiyesi" Text="" CssClass="txtBox"  Width="180px" ReadOnly="true"/>
             <br />
             <br />
                 Alacak: <asp:TextBox runat="server" ID="alacak" Text="" CssClass="txtBox"  Width="180px" ReadOnly="true"/>
             <br />
             <br />
